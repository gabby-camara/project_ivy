...
# predict
# ---------------
reg_models$ridge$pred = data.frame(Id = test$Id, SalePrice = 10^predict(reg_models$ridge$fit, s = reg_models$ridge$lambda, newx = Z))
reg_models$lasso$pred = data.frame(Id = test$Id, SalePrice = 10^predict(reg_models$lasso$fit, s = reg_models$lasso$lambda, newx = Z))
...
c = coef(reg_models$lasso$fit)[, which(reg_models$lasso$fit$lambda == reg_models$lasso$lambda )]
c[c != 0]
